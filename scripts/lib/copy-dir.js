// Shared recursive directory copy used by the asset build step.
//
// TypeScript sources are NEVER shipped — `tsc` owns the compiled main-process
// output and esbuild owns the renderer bundles, so any `.ts` file is skipped.
// Callers may additionally skip specific resolved directories/files.
